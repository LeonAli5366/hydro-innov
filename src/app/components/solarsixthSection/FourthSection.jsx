...
// Refactored FourthSection Component
const FourthSection = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(
        "https://hydro-innov-6gkn-hkxr87350-leonali5366s-projects.vercel.app/api/dashboard/tesla/sixthSection?id=4",
        {
          method: "PUT",
          headers: {
      ...
      <form>
        <div className="flex flex-col gap-y-3 w-full">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <Image
              src={input.photo || "/placeholder-image.jpg"}  // Default to a placeholder if no photo is available
              alt="Section Image"
              width={800}
              height={500}

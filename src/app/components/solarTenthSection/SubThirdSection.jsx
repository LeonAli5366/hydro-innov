...
const SubThirdSection = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      const thirdObject = tenthData?.[2] || {};
      setInput({
        title: thirdObject?.title || "",
        subtitle: thirdObject?.subtitle || "",
        photo: thirdObject?.photo || "",
      });
    };
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://hydro-innov-6gkn-hkxr87350-leonali5366s-projects.vercel.app/api/dashboard/tesla/tenthSection?id=6",
        {
          method: "PUT",
          headers: {
